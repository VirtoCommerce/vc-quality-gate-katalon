...
<WebServiceRequestEntity>
   <description>This endpoint is not used in the actual admin flow, but exists in the swagger. Coverage was requested by A.Tzykin.</description>
   <name>DynamicPropertyUpdate(cloneInSwagger)</name>
   <tag></tag>
   <elementGuidId>264608f4-f084-44f7-a1a3-10616b47b812</elementGuidId>
