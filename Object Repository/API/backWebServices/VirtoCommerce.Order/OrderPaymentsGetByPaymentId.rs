...
<WebServiceRequestEntity>
   ...
   <name>OrderPaymentsGetByPaymentId</name>
   <tag></tag>
   <elementGuidId>ed30d8ce-7b3a-47f9-8185-59a8d475ade0</elementGuidId>
   ...
   <restUrl>${GlobalVariable.urlBack}/api/order/payments/${paymentId}</restUrl>
