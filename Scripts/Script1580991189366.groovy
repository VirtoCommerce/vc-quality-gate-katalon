...
WebUI.mouseOver(findTestObject('UI-Electronics/Page_Electronics/Camcorders'))

WebUI.click(findTestObject('UI-Electronics/Page_Electronics/AeriaImagingDrones'))

WebUI.verifyElementText(findTestObject('UI-Electronics/AerialImagingCategory/H1CategoryPage'), 'AERIAL IMAGING & DRONES')

WebUI.click(findTestObject('UI-Electronics/AerialImagingCategory/IconCartOnProductsCard'))
...
WebUI.setText(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/InputEmailCheckout'), 'test@test.ru')

WebUI.click(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/FirstNameCheckout'))

WebUI.setText(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/FirstNameCheckout'), 'TestFirstName')

WebUI.click(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/LastNameCheckout'))

WebUI.setText(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/LastNameCheckout'), 'TestLastName')
...
WebUI.setText(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/AddressCheckout'), 'TestAddress')

WebUI.click(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/AptCheckout'))

WebUI.setText(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/AptCheckout'), '3321')

WebUI.click(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/CityCheckout'))

WebUI.setText(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/CityCheckout'), 'TestCity')
...
WebUI.setText(findTestObject('UI-Electronics/CartCheckoutPage/Page_Electronics - Checkout/ZIpCheckout'), '99999')
