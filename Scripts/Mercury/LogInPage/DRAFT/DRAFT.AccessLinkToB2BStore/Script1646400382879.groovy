...
WebUI.click(findTestObject('UI-Mercury/LoginPage/links/a_follow the link to access the B2B'))

WebUI.switchToWindowUrl(GlobalVariable.B2BCredentialsPage)

WebUI.mouseOver(findTestObject('UI-Mercury/LoginPage/links/a_B2BCredentialsPage'))
