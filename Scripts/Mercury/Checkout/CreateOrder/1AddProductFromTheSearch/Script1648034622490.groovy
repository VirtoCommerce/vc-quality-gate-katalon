...
WebUI.mouseOver(findTestObject('UI-Mercury/HomePageElements/1Search/div_ProductBlockSearchPage'))  
...
WebUI.click(findTestObject('UI-Mercury/CheckOut/CreateOrder/AddProduct/1button_PopUpButtonViewCart'))
