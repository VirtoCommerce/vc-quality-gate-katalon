...
WebUI.verifyElementPresent(findTestObject('UI-Mercury/Checkout/CreateOrder/AddProduct/div_AllVariationsBlock'),3)

WebUI.mouseOver(findTestObject('UI-Mercury/Checkout/CreateOrder/AddProduct/div_OneVariationBlock'))

WebUI.click(findTestObject('UI-Mercury/Checkout/CreateOrder/AddProduct/btn_AddToCart'))

WebUI.verifyElementPresent(findTestObject('UI-Mercury/Checkout/CreateOrder/AddProduct/div_PopUpProductAdded'), 3)

def AddCartProductPage = WebUI.getText(findTestObject('UI-Mercury/Checkout/CreateOrder/AddProduct/txt_PopupTitle'))
