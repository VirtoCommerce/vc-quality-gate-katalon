...
//WebUI.verifyElementPresent(findTestObject('UI-Mercury/CheckOut/CreateOrder/OrderDetailsPage/1OrderDetails/div_BlockOrderCompleted'),3)

WebUI.verifyElementText (findTestObject('UI-Mercury/CheckOut/CreateOrder/OrderDetailsPage/1OrderDetails/h5_OrderCompleted'),'ORDER COMPLETED')
...
WebUI.verifyElementText (findTestObject('UI-Mercury/CheckOut/CreateOrder/OrderDetailsPage/1OrderDetails/txt_VerifyPrice'), GlobalVariable.priceFromPopup)


//DOESNT WORK!

//WebUI.verifyElementText (findTestObject('UI-Mercury/CheckOut/CreateOrder/OrderDetailsPage/1OrderDetails/txt_VerifyQuantity'), GlobalVariable.updateQuantity)
...
WebUI.verifyElementClickable(findTestObject('UI-Mercury/CheckOut/CreateOrder/OrderDetailsPage/1OrderDetails/a_PrintButton'))
