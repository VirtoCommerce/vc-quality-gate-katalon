...
WebUI.verifyElementPresent(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/div_ShippingDetailsBlock'), 
    3)

WebUI.verifyElementText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/h3_ShippingDetailsTitle'), 
    'SHIPPING DETAILS')
...
//WebUI.verifyElementPresent(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/DRAFT/1div_ShippingAddressPopUp'),3)
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_FirstName'), 
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_LastName'), 
    GlobalVariable.contactLastName)

WebUI.setText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_Email'), 
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_Phone'), 
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_PostalCode'), 
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_City'), 
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CreateOrder/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_Road'), 
