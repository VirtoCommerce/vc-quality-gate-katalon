...
WebUI.verifyElementText(findTestObject('1 UI-B2B ST/Catalog/ProductPage/ProductLinks/a_Print'), 'Print')
WebUI.click(findTestObject('1 UI-B2B ST/Catalog/ProductPage/ProductLinks/a_Print'))
...
//WebUI.switchToFrame(findTestObject('1 UI-B2B ST/Catalog/ProductPage/ProductLinks/a_PrintPopUp'),5)
//WebUI.verifyElementVisible(findTestObject('1 UI-B2B ST/Catalog/ProductPage/ProductLinks/a_PrintPopUp'))
...
//WebUI.click(findTestObject('1 UI-B2B ST/Catalog/ProductPage/ProductLinks/a_PrintPopUpButtonCancel'))
