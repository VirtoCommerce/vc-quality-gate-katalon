...
WebUI.verifyElementPresent(findTestObject('UI-Mercury/Catalog/ProductBlockViewOnCategory/text_ProductSKU'), 4)
...
WebUI.verifyElementPresent(findTestObject('UI-Mercury/Catalog/ProductBlockViewOnCategory/text_ProductPrice'), 4)

WebUI.verifyElementPresent(findTestObject('UI-Mercury/Catalog/ProductBlockViewOnCategory/input_ProductAmountField'), 4)

WebUI.mouseOver(findTestObject('UI-Mercury/Catalog/ProductBlockViewOnCategory/div_InputAndButtonBlock'))

WebUI.mouseOver(findTestObject('UI-Mercury/Checkout/CreateOrder/AddProduct/btn_AddFromCatalog'))

WebUI.verifyElementClickable (findTestObject('UI-Mercury/Checkout/CreateOrder/AddProduct/btn_AddFromCatalog'))
