...
WebUI.verifyElementPresent(findTestObject('UI-Mercury/Registration/div_RedistrationPopUp'),3)

WebUI.click(findTestObject('UI-Mercury/Registration/div_RedistrationPopUpButton'))
