...
WebUI.verifyElementPresent(findTestObject('UI-Mercury/Registration/text_VerifyAccountName'), 0)

def AccountName = WebUI.getText(findTestObject('UI-Mercury/Registration/text_VerifyAccountName'))
