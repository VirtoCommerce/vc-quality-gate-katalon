...
def CheckAddressResult = WebUI.verifyElementPresent(findTestObject('UI/CartCheckoutPage/Page_Electronics - Checkout/SelectAddress'), 
    5)

if (CheckAddressResult == false) {
	
	WebUI.selectOptionByIndex(findTestObject('UI/CartCheckoutPage/Page_Electronics - Checkout/SelectAddress'),
		1)
