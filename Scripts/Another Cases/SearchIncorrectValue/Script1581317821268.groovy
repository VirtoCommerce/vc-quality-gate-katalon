...
WebUI.setText(findTestObject('UI/Header/Search line'), IncorrectSearchRequest)

WebUI.click(findTestObject('UI/Header/ButtonSearchHeader'))

String SearchResultCheck = 'SEARCH FOR PRODUCTS ON OUR SITE'

WebUI.verifyElementText(findTestObject('UI/SearchResultPage/H2IncorrectSearchPage'), SearchResultCheck)
