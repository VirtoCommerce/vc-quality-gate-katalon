...
WebUI.verifyElementText (findTestObject('UI-Mercury/Checkout/OrderDetailsPage/OrderDetails/txt_VerifyPrice'), GlobalVariable.priceFromPopup)


//DOESNT WORK!

//WebUI.verifyElementText (findTestObject('UI-Mercury/Checkout/OrderDetailsPage/OrderDetails/txt_VerifyQuantity'), GlobalVariable.updateQuantity)


//verify gift

WebUI.verifyElementPresent(findTestObject('UI-Mercury/Checkout/OrderDetailsPage/OrderDetails/div_Gift'), 3)
