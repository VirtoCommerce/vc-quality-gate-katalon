...
WebUI.verifyElementPresent(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/div_ShippingDetailsBlock'),3)

WebUI.verifyElementText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/h3_ShippingDetailsTitle'),'SHIPPING DETAILS')
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_FirstName'), GlobalVariable.contactFirstName)
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_LastName'), GlobalVariable.contactLastName)
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_Email'), GlobalVariable.contactEmail)
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_Phone'), GlobalVariable.contactPhone)
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_PostalCode'), GlobalVariable.organizationPostalCode)
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_City'), GlobalVariable.organizationCity)
...
WebUI.setText(findTestObject('UI-Mercury/Checkout/CheckoutPage/ShippingDetails/ShippingAddress/FillInShippingAddress/input_Road'), GlobalVariable.organizationStreet)
