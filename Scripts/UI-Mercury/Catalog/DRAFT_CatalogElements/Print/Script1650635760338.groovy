...
WebUI.verifyElementText(findTestObject('UI-B2B store/Catalog/ProductPage/ProductLinks/a_Print'), 'Print')
WebUI.click(findTestObject('UI-B2B store/Catalog/ProductPage/ProductLinks/a_Print'))
...
//WebUI.switchToFrame(findTestObject('UI-B2B store/Catalog/ProductPage/ProductLinks/a_PrintPopUp'),5)
//WebUI.verifyElementVisible(findTestObject('UI-B2B store/Catalog/ProductPage/ProductLinks/a_PrintPopUp'))
...
//WebUI.click(findTestObject('UI-B2B store/Catalog/ProductPage/ProductLinks/a_PrintPopUpButtonCancel'))
