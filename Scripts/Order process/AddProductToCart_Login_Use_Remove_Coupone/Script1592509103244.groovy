...
WebUI.setText(findTestObject('CartCheckoutPage/Page_Electronics - Checkout/InputCoupone'), 'CCP')

//WebUI.waitForElementNotVisible(findTestObject('Object Repository/CartCheckoutPage/Page_Electronics - Checkout/CreateOrderSpinner'), 20)

WebUI.click(findTestObject('CartCheckoutPage/Page_Electronics - Checkout/SpanApply'))

WebUI.verifyElementVisible(findTestObject('CartCheckoutPage/Page_Electronics - Checkout/PCouponeValid'))
