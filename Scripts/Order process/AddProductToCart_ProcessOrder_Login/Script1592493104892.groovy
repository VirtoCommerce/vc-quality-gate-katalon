...
def PriceFromPopup1 = WebUI.getText(findTestObject('Object Repository/PopupAddToCart/Page_Aerial Imaging  Drones - Electronics/SpanPriceInPopup'))

WebUI.click(findTestObject('PopupAddToCart/Page_Aerial Imaging  Drones - Electronics/ButtonGoToCart'))

WebUI.click(findTestObject('CartCheckoutPage/Page_Electronics - Checkout/SpanPlus'))

WebUI.waitForElementClickable(findTestObject('CartCheckoutPage/Page_Electronics/ButtonCheckoutOnCart'), 10)

WebUI.mouseOver(findTestObject('CartCheckoutPage/Page_Electronics - Checkout/SpanItemTotal'))

def SubTotalFromCart = WebUI.getText(findTestObject('Object Repository/CartCheckoutPage/Page_Electronics - Checkout/SpanItemTotal'))

WebUI.click(findTestObject('CartCheckoutPage/Page_Electronics/ButtonCheckoutOnCart'))

WebUI.callTestCase(findTestCase('LoginFromCart'), [('login') : GlobalVariable.UserLogPass, ('password') : GlobalVariable.UserLogPass], 
...
WebUI.verifyEqual(SubTotalFromCart, WebUI.getText(findTestObject('CartCheckoutPage/Page_Electronics - Checkout/DivSubtotal')))
