...
WebUI.comment('TEST CASE: Add new property to VirtoCommerce.CartModule.Core.Model.LineItem')

propertyType = 'VirtoCommerce.CartModule.Core.Model.LineItem' 
propertyName = 'Qwe Property CartModule LineItem'
