...
WebUI.comment('TEST CASE: Create a new propertys for CustomerModule - Organization');

// splitting a property name by entities
String propertyType = 'VirtoCommerce.CustomerModule.Core.Model.Organization';
