...
for (int a; a < userNameList.size();a++) {
	if (userNameList[a] == GlobalVariable.userName) {
		...
		passwordChangeWrongPasswords = WS.sendRequest(findTestObject('API/backWebServices/VirtoCommerce.Platform/UserPassword/UserPasswordChangeByUserName',[
	  ...
	  passwordChangeWrongUserName = WS.sendRequest(findTestObject('API/backWebServices/VirtoCommerce.Platform/UserPassword/UserPasswordChangeByUserName',[
