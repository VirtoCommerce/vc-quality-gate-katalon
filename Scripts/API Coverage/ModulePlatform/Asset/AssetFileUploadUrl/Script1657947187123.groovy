...
uploadForbiddenFileUrl = WS.sendRequest(findTestObject('API/backWebServices/VirtoCommerce.Platform/_DRAFT/Assets/AssetFileUpload', [
...
uploadFileUrl = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Platform/_DRAFT/Assets/AssetFileUpload', [
	('folderUrl') : GlobalVariable.folderUrl,
	('url') : correctFileUrl
	]))
//get file url
