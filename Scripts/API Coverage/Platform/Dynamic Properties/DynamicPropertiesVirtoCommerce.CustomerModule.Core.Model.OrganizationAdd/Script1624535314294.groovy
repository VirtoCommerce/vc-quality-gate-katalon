...
WebUI.comment('TEST CASE: Add new property to VirtoCommerce.CustomerModule.Core.Model.Organization')

response = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Platform/DynamicPropertiesAddNew', 
        [('propertyType') : 'VirtoCommerce.CustomerModule.Core.Model.Organization', ('name') : 'Test Property Store']))

WS.verifyElementPropertyValue(response, 'objectType', 'VirtoCommerce.CustomerModule.Core.Model.Organization')
