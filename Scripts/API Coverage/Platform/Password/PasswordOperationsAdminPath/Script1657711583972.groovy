...
//authorize = WS.callTestCase(findTestCase('API Coverage/Platform/Password/UserCreateAdminAndGetToken'),
//	null)
//
...
passwordChangeNegative = WS.sendRequest(findTestObject('API/backWebServices/VirtoCommerce.Platform/_Password/PasswordChangeByUserName',[
...
passwordReset = WS.sendRequestAndVerify(findTestObject('Object Repository/API/backWebServices/VirtoCommerce.Platform/ResetPassword',[
...
paswordChangeGeneric = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Platform/_Password/PasswordChangeByUserName',[
	 ('userName') : GlobalVariable.userName,
