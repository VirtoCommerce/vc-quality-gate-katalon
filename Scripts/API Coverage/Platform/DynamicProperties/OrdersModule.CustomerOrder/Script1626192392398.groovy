...
WebUI.comment('TEST CASE: Add new property to VirtoCommerce.OrdersModule.Core.Model.CustomerOrder')
...
WS.verifyElementPropertyValue(response, 'objectType', 'VirtoCommerce.OrdersModule.Core.Model.CustomerOrder')
...
WS.verifyElementPropertyValue(response, 'results[0].objectType', "VirtoCommerce.OrdersModule.Core.Model.CustomerOrder")
...
//------------------------------
WebUI.comment('TEST CASE: Update property VirtoCommerce.OrdersModule.Core.Model.CustomerOrder')
