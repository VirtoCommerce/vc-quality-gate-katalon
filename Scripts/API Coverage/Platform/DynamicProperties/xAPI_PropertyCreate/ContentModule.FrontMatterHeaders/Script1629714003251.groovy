...
WebUI.comment('TEST CASE: Create a new propertys for ContentModule - FrontMatterHeaders');

// splitting a property name by entities
String propertyType = 'VirtoCommerce.ContentModule.Core.Model.FrontMatterHeaders';
