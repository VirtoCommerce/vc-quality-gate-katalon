...
WS.verifyElementPropertyValue(response, 'objectType', 'VirtoCommerce.OrdersModule.Core.Model.Shipment')
...
WS.verifyElementPropertyValue(response, 'results[0].objectType', "VirtoCommerce.OrdersModule.Core.Model.Shipment")
...
//------------------------------
WebUI.comment('TEST CASE: Update property VirtoCommerce.OrdersModule.Core.Model.Shipment')
...
//------------------------------
WebUI.comment('TEST CASE: Delete property VirtoCommerce.OrdersModule.Core.Model.Shipment')
