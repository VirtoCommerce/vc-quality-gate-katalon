...
'UPDATE CONTACT'
GlobalVariable.contactName = GlobalVariable.contactName + 'Updated'
...
verification = WS.callTestCase(findTestCase('API Coverage/Contacts/_module_Customer/contactGet'),
	null,
	FailureHandling.STOP_ON_FAILURE)
WS.verifyElementPropertyValue(verification, 'fullName', GlobalVariable.contactName)
