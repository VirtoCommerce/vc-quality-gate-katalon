...
response = WS.sendRequestAndVerify(findTestObject('API/backWebServices/Customer management module/Organizations/OrganizationsSearch', [('searchPhrase') : GlobalVariable.firstName] ))
