...
WebUI.comment('TEST CASE: categories management - get a category')
...
WS.verifyElementPropertyValue(categoryGet, 'name', GlobalVariable.categoryName)
WS.verifyElementPropertyValue(categoryGet, 'code', GlobalVariable.categoryCode)