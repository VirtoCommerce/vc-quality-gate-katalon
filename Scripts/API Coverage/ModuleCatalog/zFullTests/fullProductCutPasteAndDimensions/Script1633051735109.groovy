...
moveProduct = WS.callTestCase(findTestCase('API Coverage/ModuleCatalog/productsMoveToTheCatalog'),null,
FailureHandling.STOP_ON_FAILURE)
...
updateDimensions = WS.callTestCase(findTestCase('API Coverage/ModuleCatalog/productUpdate'),null,
FailureHandling.STOP_ON_FAILURE)
...
'DELETE PRODUCT'
productDelete = WS.callTestCase(findTestCase('API Coverage/ModuleCatalog/productsDelete'),
	null,
	FailureHandling.STOP_ON_FAILURE)
