...
folderBodyGet = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Marketing/DynamicContent/ContentFolders/ContentFodlerGet',[
...
RequestObject updateFodler= findTestObject('API/backWebServices/VirtoCommerce.Marketing/DynamicContent/ContentFolders/ContentFolderUpdate')
...
updatedFolderGet = WS.sendRequestAndVerify(findTestObject('API/backWebServices/VirtoCommerce.Marketing/DynamicContent/ContentFolders/ContentFodlerGet',[
	('folderId') : GlobalVariable.folderId
	]))
